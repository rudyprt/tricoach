...
export function StravaReturn() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-sm space-y-3 rounded-2xl border border-bordure bg-zinc-950/80 p-6 text-center">
        {error ? (
          <>
          ...
          <>
            <Spinner />
            <p className="text-sm text-doux">Connexion à Strava…</p>
          </>
        )}
      </div>
    </div>
